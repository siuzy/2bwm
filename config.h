 ...
 *6)emptycol         */
 static const char *colors[] = {"#ffffff","#0d0d0d","#505050","#ffffff","#7e62b3","#000000","#000000"};
...
///--Menus and Programs---///
static const char *menucmd[] = { "rofi", "-show", "run", "-lines", "5", "-width", "20", "-hide-scrollbar", NULL};
...
static key keys[] = {
    ...
    {  MOD ,              XK_semicolon,  changescreen,      {.i=TWOBWM_NEXT_SCREEN}},
    {  MOD ,              XK_comma,  	 changescreen,      {.i=TWOBWM_PREVIOUS_SCREEN}},
    // Raise or lower a window
    {  MOD ,              XK_r,          raiseorlower,      {}},
    // Next/Previous workspace
    {  MOD ,              XK_e,          nextworkspace,     {}},
    {  MOD ,              XK_w,          prevworkspace,     {}},
    // Move to Next/Previous workspace
    {  MOD |SHIFT ,       XK_e,          sendtonextworkspace,{}},
    {  MOD |SHIFT ,       XK_w,          sendtoprevworkspace,{}},
    // Iconify the window
    //{  MOD ,              XK_i,          hide,              {}},
